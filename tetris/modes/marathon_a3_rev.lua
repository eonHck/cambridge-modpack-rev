...
local MarathonA3GameRev = GameMode:extend()

MarathonA3GameRev.name = "Marathon A3 Rev"
MarathonA3GameRev.hash = "MarathonA3Rev"
MarathonA3GameRev.tagline = "The game gets faster way more quickly! Can you get all the Section COOLs?"


function MarathonA3GameRev:new()
	MarathonA3GameRev.super:new()
...
function MarathonA3GameRev:getARE()
...
function MarathonA3GameRev:getLineARE()
...
function MarathonA3GameRev:getDasLimit()
		if self.speed_level < 500 then return 15
	elseif self.speed_level < 900 then return 9
	else return 7 end
end

function MarathonA3GameRev:getLineClearDelay()
...
function MarathonA3GameRev:advanceOneFrame()
	if self.clear then
...
function MarathonA3GameRev:onPieceEnter()
...
function MarathonA3GameRev:onLineClear(cleared_row_count)
...
function MarathonA3GameRev:updateSectionTimes(old_level, new_level)
...
function MarathonA3GameRev:updateScore(level, drop_bonus, cleared_lines)
...
function MarathonA3GameRev:whilePieceActive()
...
function MarathonA3GameRev:updateGrade(cleared_lines)
...
function MarathonA3GameRev:qualifiesForMRoll()
	return self.grade >= 27 and self.section_cool_grade >= 9
end

function MarathonA3GameRev:getAggregateGrade()
	return math.min(
...
function MarathonA3GameRev:getLetterGrade()
...
function MarathonA3GameRev:drawGrid()
...
MarathonA3GameRev.rollOpacityFunction = function(age)
	if age < 240 then return 1
	elseif age > 300 then return 0
	else return 1 - (age - 240) / 60 end
end

MarathonA3GameRev.mRollOpacityFunction = function(age)
	if age > 4 then return 0
	else return 1 - age / 4 end
end

function MarathonA3GameRev:sectionColourFunction(section)
...
function MarathonA3GameRev:drawScoringInfo()
...
function MarathonA3GameRev:getHighscoreData()
	return {
...
function MarathonA3GameRev:getSectionEndLevel()
	if self.level >= 900 then return 999
	else return math.floor(self.level / 100 + 1) * 100 end
end

function MarathonA3GameRev:getBackground()
	return math.floor(self.speed_level / 100)
end

return MarathonA3GameRev